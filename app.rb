...
class Spotifyifyly < Sinatra::Base
  ...
  post "/save_song" do
    ...
    j = params[:result]
    t = JSON.parse(j)
    s = Song.create( title: t["title"], suggested_by: current_user, artist: t["artist"], spotify_preview_url: t["preview_url"], album_name: t["album_name"], album_image: t["album_image"], ur: t["uri"])
